...
INSERT INTO ad_sysconfig (ad_sysconfig_id, ad_client_id, ad_org_id, created, createdby, updated, updatedby, isactive, name, value, description, entitytype, configurationlevel, ad_sysconfig_uu) VALUES 
(nextidfunc(50009,'N'), 0, 0, now(), 100, now(), 100, 'Y', 'GMAP_MODULE_STOP_RED','stopBlue.png','Иконка объекта для неподвижного объекта при отсутствии связи', 'U', 'C', uuid_generate_v4());
...
INSERT INTO ad_sysconfig (ad_sysconfig_id, ad_client_id, ad_org_id, created, createdby, updated, updatedby, isactive, name, value, description, entitytype, configurationlevel, ad_sysconfig_uu) VALUES 
(nextidfunc(50009,'N'), 0, 0, now(), 100, now(), 100, 'Y', 'GMAP_MODULE_MARKER_RED','navRed','Часть имени файла иконки для врашающихся объектов (от -0 до -360.png) красная при отсутствии связи', 'U', 'C', uuid_generate_v4());

INSERT INTO ad_sysconfig (ad_sysconfig_id, ad_client_id, ad_org_id, created, createdby, updated, updatedby, isactive, name, value, description, entitytype, configurationlevel, ad_sysconfig_uu) VALUES 
(nextidfunc(50009,'N'), 0, 0, now(), 100, now(), 100, 'Y', 'GMAP_MODULE_SERVICE_MARKER','navService.png','Иконка объекта при назначении на сервис', 'U', 'C', uuid_generate_v4());

INSERT INTO ad_sysconfig (ad_sysconfig_id, ad_client_id, ad_org_id, created, createdby, updated, updatedby, isactive, name, value, description, entitytype, configurationlevel, ad_sysconfig_uu) VALUES 
(nextidfunc(50009,'N'), 0, 0, now(), 100, now(), 100, 'Y', 'GMAP_MODULE_ALERT_MARKER','navAlert.png','Иконка объекта при возникновении события', 'U', 'C', uuid_generate_v4());

INSERT INTO ad_sysconfig (ad_sysconfig_id, ad_client_id, ad_org_id, created, createdby, updated, updatedby, isactive, name, value, description, entitytype, configurationlevel, ad_sysconfig_uu) VALUES 
(nextidfunc(50009,'N'), 0, 0, now(), 100, now(), 100, 'Y', 'GMAP_MODULE_UNKNOWN','navUnknown.png','Иконка неизвестного состояния', 'U', 'C', uuid_generate_v4());
