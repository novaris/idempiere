...
<%-- Определение цвета линии таблиц --%>
.z-listitem.z-listitem-selected>.z-listcell {
    background: #FBD87E !important;
}
<%-- Определение высоты содержимого таблиц --%>
.z-listcell-content {
    line-height: 15px !important;
}

<%-- Определение голубого фона во внутренней форме--%>
.z-vlayout-inner {
...
.z-treerow [class^="z-icon-"], .z-treerow [class*=" z-icon-"]{
    ...
    background-image: url(/webui/theme/business/images/arrow-toggle.png) !important;
    width: 18px;
    height: 18px;
    font-size: 15px;
    color: transparent;
...
.z-popup-content { /* подложка для меню сессий */
    background: #606C7D;
}
...
.z-window-content .z-center-body { /*Фон для графики*/
    background-color: #fff;
}

.z-listbox-body {  /*Оформление таблиц справочной информации*/
    background-color: #ffffff;
}

.z-row:hover > .z-row-inner, .z-row:hover > .z-cell { /*Прозрачность позволяет избежать эффекта затенения*/
    background-color: transparent !important;
    background: transparent;
        background-color: transparent !important;
}

.adwindow-detailpane-tabbox { /*цветной фон закладки подробнее*/
    background-color: #EEF1F6;
}

/*Меню*/

.global-search-tabpanel .z-listbox-body {    /*существет в ThemeCSS*/
...
/*заголовок hd в таблицах заказов*/
...
/*фоновый эффект таблицы перед покраской*/
...
<c:include page="fragment/openlayers.css.dsp" />
